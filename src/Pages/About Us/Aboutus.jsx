    ...
    <>
      ...
      <div className='items-center justify-center ml-[10vw] mr-[10vw] mt-[5vw]'>
        ...
        >
          ...
          We believe that a well-crafted resume can make a significant difference in your
          job search, helping you stand out from the competition and land your dream job.
          <br /> 
          
          <div class="md:inline-flex my-10 md:ml-10 shadow rounded-sm w-full justify-center">
            {/* About us image */}
            <img src={AboutUsImage} alt="Logo" class="object-none object-center" />
          </div>
